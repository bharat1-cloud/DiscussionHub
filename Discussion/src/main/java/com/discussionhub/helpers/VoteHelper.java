...
public class VoteHelper {
    ...
    public static void addVote(Connection conn, int userId, int questionId, int answerId, String type) throws SQLException {
    ...
    public static String getUserVoteType(Connection conn, int userId, int questionId, int answerId) throws SQLException {
    ...
    public static void updateVote(Connection conn, int userId, int questionId, int answerId, String newType) throws SQLException {
    ...
    public static String getExistingVoteType(Connection conn, int userId, int questionId, int answerId) throws SQLException {
        String sql = "SELECT vote_type FROM votes WHERE user_id = ? AND " + (questionId != 0 ? "question_id = ?" : "answer_id = ?");
        PreparedStatement ps = conn.prepareStatement(sql);
        ps.setInt(1, userId);
        ps.setInt(2, questionId != 0 ? questionId : answerId);
        ResultSet rs = ps.executeQuery();
